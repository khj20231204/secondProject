# secondProjec - 두번째 프로젝트 : 화상 공방
   <img src="readme_main.jpg" style="border:3px solid black;border-radius:9px;width:500px">    
...
1. # 개발 환경
   <img src="develop_env.png" style="border:3px solid black;border-radius:9px;width:500px">    

1. # 역할 분담
   <img src="part.png" style="border:3px solid black;border-radius:9px;width:500px">    

1. # 개발 일정
   전체 개발 기간은 1개월이였습니다.   
   <img src="schedule.png" style="border:3px solid black;border-radius:9px;width:500px">    

1. # ERD
   <img src="erd.png" style="border:3px solid black;border-radius:9px;width:500px">    

1. # WorkFlow
      <img src="workflow.png" style="border:3px solid black;border-radius:9px;width:500px">    
